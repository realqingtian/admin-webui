...
export default {
  ...
  menuDemo: {
    fallback: '请从左侧选择一个子菜单',
    nav: {
      tag: '页面切换演示',
      title: '点击下方按钮 / 点击左侧二级菜单项 即可切换页面',
      current: '当前所在',
      active: '当前',
    },
    menu1: {
      title: '菜单 1 · 计数器与特性',
      intro: '这是二级菜单的「菜单 1」页面。点一级菜单标题可以展开/收起二级菜单,点二级项可切换不同页面。',
      counterCard: '交互演示',
      featuresCard: '本页面特性',
      counter: '当前计数',
      add: '增加',
    ...
    menu2: {
      title: '菜单 2 · 信息架构',
      intro: '这是「菜单 2」,用 Tabs + 描述列表演示二级菜单下页面内容的切换。',
      tabOverview: '概览',
      tabSpec: '规格',
      tabFaq: '常见问题',
      overviewTitle: '基本信息',
      ...
      faq: {
        q1: '如何新增二级菜单?',
        a1: '在 src/config/menu.ts 给对应一级菜单加 children 字段,并在 router 注册子路由。',
        q2: '一级菜单可以点击吗?',
        a2: '可以,点击一级菜单标题可展开/收起二级菜单,不会发生跳转。',
        q3: '二级菜单可以跳到外部链接吗?',
        a3: '可以,自行扩展 handleSubMenuClick 判断 path 是否为 http(s) 开头。',
      },
    },
    menu3: {
      title: '菜单 3 · 简单记事本',
      intro: '这是「菜单 3」,演示一个可增删/勾选的迷你记事本,验证二级菜单下的页面交互。',
      form: {
        title: '事项',
        titlePlaceholder: '请输入事项标题',
        tag: '分类',
      },
      add: '新增',
      cols: {
